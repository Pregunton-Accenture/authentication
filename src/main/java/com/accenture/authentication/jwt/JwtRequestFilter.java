...
public class JwtRequestFilter extends OncePerRequestFilter {
   ...
   * <br><br>
   * The authentication token will be add if the username is not {@code null} and if the authentication of the security
   * context is {@code null} and if the the token and the user credentials are valid.
   *
